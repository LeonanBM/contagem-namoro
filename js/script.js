...
// Contador de Tempo
const startDate = new Date('October 19, 2022 22:30:00').getTime(); // Ajuste conforme necessário
...
// Ajuste do volume inicial da música
const audioPlayer = document.getElementById('love-music');
if (audioPlayer) {
    audioPlayer.volume = 0.5; // Define o volume em 50%
}
